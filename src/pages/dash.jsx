    ...
    <PageContainer>
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <StatCard label="Steps" value={watch.data.steps} goal="10000" />
          <StatCard label="Sleep (hrs)" value={watch.data.sleep} goal="8" />
          <StatCard label="Resting HR" value={watch.data.heartRate} />
        </div>
